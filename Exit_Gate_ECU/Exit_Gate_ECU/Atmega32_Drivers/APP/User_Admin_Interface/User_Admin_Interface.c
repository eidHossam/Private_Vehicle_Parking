 ...
 * 
 * @brief This file contains the APIs and the states declarations for the main module of the exit gate ECU,
...
static const uint8_t Glob_u8GateAddress = GATE_ECU_ADDRESS;
/**
  * @}
  */
